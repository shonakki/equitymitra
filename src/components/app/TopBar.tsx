...
const TICKERS = [
  { name: "NIFTY", value: "24,812.40", chg: "+184.30", pct: "+0.75%", up: true },
  { name: "SENSEX", value: "81,205.10", chg: "+612.45", pct: "+0.76%", up: true },
  { name: "BANKNIFTY", value: "51,420.05", chg: "-126.40", pct: "-0.25%", up: false },
];
