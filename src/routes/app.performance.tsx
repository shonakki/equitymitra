...
const CATS = ["All", "Intraday", "Swing", "Positional", "Mid Term", "Long Term", "High Conviction"] as const;
...
const ROWS: Row[] = [
  ...
  { s: "KAYNES", entry: 4900, current: 5420, status: "Active", days: 62, cat: "High Conviction" },
  ...
  { s: "POLYCAB", entry: 5240, current: 6180, status: "Closed", days: 92, cat: "High Conviction" },
