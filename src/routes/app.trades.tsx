...
const CATS = ["Intraday", "Positional", "Swing", "Mid Term", "Long Term", "High Conviction"] as const;
...
const ALL: Trade[] = [
  ...
  {
    s: "KAYNES", exch: "NSE • Weekly", category: "High Conviction", side: "Bullish", setup: "ATE",
